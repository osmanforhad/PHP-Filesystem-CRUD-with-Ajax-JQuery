<?php
//Start Function formation of Folder Size
function format_folder_size($size) {
    ...
    return $size;
}//End of Function formation of Folder Size

//Start function for get Folder Size Block
...
}//End of function for get Folder Size Block

//Start Data Table Block
...
//Start Folder Create Block
    ...
    }//End of Folder Create Block
    
    //Start Rename or Update Foldar Block
    ...
    }//End of Rename or Update Foldar Block
    
//Strat Folder Delete Block
    ...
    }//End of Folder Delete Block
    
//Start View File Details Block
  ...
  ';
    ...
    ';
        ...
        $output .= '</table>';
        echo $output;
    }//End of View File Details Block
    
//Start Remove File Block
    if ($_POST["action"] == "remove_file") {
        if (file_exists($_POST["path"])) {
            unlink($_POST["path"]);
            echo 'File Deleted';
        }
    }//End of Remove File Block
    
//Start Change File name Block 
