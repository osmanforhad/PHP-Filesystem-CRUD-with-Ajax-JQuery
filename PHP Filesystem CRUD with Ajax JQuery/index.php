...
<html>
    <head>
        <title>Create Folder || Rename Folder || Delete Folder || Upload File || View File || Remove File</title>
    ...
    <body>
        <br /><br />
        <div class="container">
            <h2 align="center">Create Folder || Rename Folder || Delete Folder || Upload File || View File || Remove File</a></h2>
            <br />
            <div align="right">
